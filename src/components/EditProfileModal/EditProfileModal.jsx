    ...
    <div className={s.modalOverlay}>
      <div className={s.modal}>
        ...
        <div className={s.imageUpload}>
          <img 
            src={selectedFile ? URL.createObjectURL(selectedFile) : currentUser.photo || 'path/to/default-avatar.png'} 
            alt="User" 
          />
        ...
        >
          {({ isSubmitting }) => (
            ...
            <button className={s.modalButton} type="submit" disabled={isSubmitting}>
              Send
            </button>
          </Form>
          )}
